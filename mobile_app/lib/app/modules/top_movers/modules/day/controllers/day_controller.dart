...
class DayController extends GetxController with StateMixin<List<Portfolio?>> {
  ...
  DayController({required this.repository});

  Repository<Leaderboard?> getTopMovers() {
    return repository.getTopMovers(
        limit: 10, mostRecent: true, span: HISTORICAL_SPAN.DAY);
  }
