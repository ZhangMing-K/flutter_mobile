...
class WeekController extends GetxController with StateMixin<List<Portfolio?>> {
  ...
  WeekController({required this.repository});

  Repository<Leaderboard?> getTopMovers() {
    return repository.getTopMovers(
        limit: 10, mostRecent: true, span: HISTORICAL_SPAN.WEEK);
  }
