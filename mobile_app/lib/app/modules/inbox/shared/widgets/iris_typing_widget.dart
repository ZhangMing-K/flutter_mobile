...
class IrisTypingWidget extends StatefulWidget {
  const IrisTypingWidget({
    Key? key,
  ...
  @override
  _IrisTypingWidgetState createState() => _IrisTypingWidgetState();
}

class _IrisTypingWidgetState extends State<IrisTypingWidget>
  ...
  @override
  void didUpdateWidget(IrisTypingWidget oldWidget) {
