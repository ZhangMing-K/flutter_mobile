...
class OrderOptionTable extends StatelessWidget {
            ...
            return SizedBox(
                ...
                child: HorizontalDataTable(
                  ...
                  rightHandSideColumnWidth:
                      optionTableWidth.fold(0, (p, c) => p + c * scaleFactor),
                  isFixedHeader: true,
                      ...
                      : [
                          ...
                          Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  headerItem(
                                      text: optionTableHeader[0],
                                      width: optionTableWidth[0],
                                      sortBy: SORT_BY.TIME,
                                      alignment: Alignment.center),
                                  headerItem(
                                      text: optionTableHeader[1],
                                      width: optionTableWidth[1],
                                      sortBy: SORT_BY.STRATEGY,
                                      alignment: Alignment.center),
                                  headerItem(
                                      text: optionTableHeader[2],
                                      sortBy: SORT_BY.TRADER_PERCENTILE,
                                      alignment: Alignment.center),
                                  headerItem(
                                      text: optionTableHeader[3],
                                      width: optionTableWidth[3],
                                      sortBy: SORT_BY.INVESTED,
                                      alignment: Alignment.center),
                                  headerItem(
                                      text: optionTableHeader[4],
                                      sortBy: SORT_BY.TRADER_ACCURACY,
                                      alignment: Alignment.center),
                                  headerItem(
                                    text: optionTableHeader[5],
                                    sortBy: SORT_BY.TRADER_ACCURACY,
                                  ),
                                  headerItem(
                                      text: optionTableHeader[6],
                                      sortBy: SORT_BY.TRADER_ACCURACY),
                                  headerItem(
                                      text: optionTableHeader[7],
                                      sortBy: SORT_BY.TRADER_ACCURACY),
                                  headerItem(
                                      text: optionTableHeader[8],
                                      sortBy: SORT_BY.TRADER_ACCURACY),
                                  headerItem(
                                      text: optionTableHeader[9],
                                      sortBy: SORT_BY.TRADER_ACCURACY),
                                  headerItem(
                                      text: optionTableHeader[10],
                                      sortBy: SORT_BY.TRADER_ACCURACY),
                                  headerItem(
                                      text: optionTableHeader[11],
                                      sortBy: SORT_BY.TRADER_ACCURACY),
                                ],
                              )),
                        ],
                  ...
                  rightSideItemBuilder: (BuildContext context, int index) {
                    return orderFlowsItem(
                        dataSource[index],
                        index,
                        isOrderToday(
                            dataSource[index].order!.fullfilledAt!.toLocal()));
                  },
  ...
  Widget orderFlowsItem(OrderFlow ta, int index, bool isOrderToday) {
...
class OrderOptionTableController extends BouncingNestedScrollController {
