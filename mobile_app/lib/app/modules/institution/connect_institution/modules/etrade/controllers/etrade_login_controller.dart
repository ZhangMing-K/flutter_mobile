...
class EtradeLoginController extends GetxController {
  ...
  EtradeLoginController({this.portfolioKey, int? selectedTab}) {
  ...
  handleError(String message) {
    if (message.contains('frequent')) {
      Get.dialog(IrisDialog(
          title:
              'Etrade is having issues sending verification codes for your account',
          onConfirm: () {
            Get.back();
          },
          ...
          asyncFunction: () async {
            try {
              return await institutionService.connect(
                  institutionName: INSTITUTION_NAME.ETRADE,
