...
class RobinhoodAddAccounts extends GetView<RobinhoodLoginController> {
  const RobinhoodAddAccounts({Key? key}) : super(key: key);
      ...
      if (institutionAccounts!.isEmpty) {
        return Column(
          children: const [
            ...
            Text(
              'No brokerage accounts on Robinhood to connect',
