...
class FidelityAddAccounts extends GetView<FidelityLoginController> {
  const FidelityAddAccounts({Key? key}) : super(key: key);
      ...
      if (institutionAccounts!.isEmpty) {
        return Column(
          children: const [
            ...
            Text(
              'No brokerage accounts on Fidelity to connect.',
