...
class FidelityLoginController extends GetxController {
  ...
  FidelityLoginController({this.portfolioKey, int? selectedTab}) {
          ...
          asyncFunction: () async {
            try {
              return await institutionService.connect(
                  institutionName: INSTITUTION_NAME.FIDELITY,
