...
class TDAmeritradeAddAccounts extends GetView<TDAmeritradeLoginController> {
  const TDAmeritradeAddAccounts({Key? key}) : super(key: key);

  actionButtons(BuildContext context) {
    return Container(
      ...
      if (institutionAccounts!.isEmpty) {
        return Column(
          children: const [
            ...
            Text(
              'No brokerage accounts on TD Ameritrade to connect',
