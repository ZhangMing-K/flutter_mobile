...
TextStyle _themeTextStyle(BuildContext context,
    {bool isValid = true, Color? textColor}) {
...
enum IrisCupertinoDatePickerMode {
...
///
/// There are several modes of the date picker listed in [IrisCupertinoDatePickerMode].
///
...
///  * [CupertinoPicker], the class that implements a content agnostic spinner UI.
class IrisCupertinoDatePicker extends StatefulWidget {
  /// Constructs an iOS style date picker.
  ///
  /// [mode] is one of the mode listed in [IrisCupertinoDatePickerMode] and defaults
  /// to [IrisCupertinoDatePickerMode.dateAndTime].
  ///
  /// [onDateTimeChanged] is the callback called when the selected date or time
  /// changes and must not be null. When in [IrisCupertinoDatePickerMode.time] mode,
  /// the year, month and day will be the same as [initialDateTime]. When in
  /// [IrisCupertinoDatePickerMode.date] mode, this callback will always report the
  ...
  /// In [IrisCupertinoDatePickerMode.time] mode, [minimumDate] should typically be
  ...
  /// In [IrisCupertinoDatePickerMode.time] mode, [maximumDate] should typically be
  /// on the same date as [initialDateTime], as the picker will not limit the
  ...
  /// [IrisCupertinoDatePickerMode.date] mode. Defaults to 1 and must not be null.
  ///
  /// [maximumYear] is the maximum year that the picker can be scrolled to in
  /// [IrisCupertinoDatePickerMode.date] mode. Null if there's no limit.
  ///
  /// [minuteInterval] is the granularity of the minute spinner. Must be a
  /// positive integer factor of 60.
  ///
  /// [use24hFormat] decides whether 24 hour format is used. Defaults to false.
  IrisCupertinoDatePicker(
      {Key? key,
      this.mode = IrisCupertinoDatePickerMode.dateAndTime,
      ...
      : initialDateTime = initialDateTime ?? DateTime.now(),
        ...
        super(key: key) {
    assert(
      mode != IrisCupertinoDatePickerMode.dateAndTime ||
          minimumDate == null ||
  ...
  /// The mode of the date picker as one of [IrisCupertinoDatePickerMode].
  /// Defaults to [IrisCupertinoDatePickerMode.dateAndTime]. Cannot be null and
  /// value cannot change after initial build.
  final IrisCupertinoDatePickerMode mode;
  ...
  ///
  /// In [IrisCupertinoDatePickerMode.time] mode, a time becomes unselectable if the
  ...
  State<StatefulWidget> createState() {
    ...
    // state.
    switch (mode) {
      case IrisCupertinoDatePickerMode.time:
      case IrisCupertinoDatePickerMode.dateAndTime:
        return _CupertinoDatePickerDateTimeState();
      case IrisCupertinoDatePickerMode.date:
  ...
  static double _getColumnWidth(
    ...
    final TextPainter painter = TextPainter(
      text: TextSpan(
        style: _themeTextStyle(context, textColor: textColor),
        text: longestText,
      ),
...
class _CupertinoDatePickerDateTimeState extends State<IrisCupertinoDatePicker> {
  ...
  @override
  void didUpdateWidget(IrisCupertinoDatePicker oldWidget) {
  ...
  double _getEstimatedColumnWidth(
      _PickerColumnType columnType, Color? textColor) {
    if (estimatedColumnWidths[columnType.index] == null) {
      estimatedColumnWidths[columnType.index] =
          IrisCupertinoDatePicker._getColumnWidth(
              columnType, localizations, context, textColor);
    }
      ...
      child: CupertinoPicker.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return itemPositioningBuilder(
            context,
            Text(dateText,
                style: _themeTextStyle(context, textColor: widget.textColor)),
          );
        },
        ...
        children:
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: _themeTextStyle(context,
                  isValid: !isInvalidMinute, textColor: widget.textColor),
            ),
          );
        }),
        looping: true,
  ...
  Widget build(BuildContext context) {
    ...
    final List<double> columnWidths = <double>[
      _getEstimatedColumnWidth(_PickerColumnType.hour, widget.textColor),
      _getEstimatedColumnWidth(_PickerColumnType.minute, widget.textColor),
    ];
    ...
    if (!widget.use24hFormat) {
      if (localizations.datePickerDateTimeOrder ==
        ...
        columnWidths.add(_getEstimatedColumnWidth(
            _PickerColumnType.dayPeriod, widget.textColor));
      } else {
    ...
    if (widget.mode == IrisCupertinoDatePickerMode.dateAndTime) {
      if (localizations.datePickerDateTimeOrder ==
              DatePickerDateTimeOrder.time_dayPeriod_date ||
          localizations.datePickerDateTimeOrder ==
        ...
        columnWidths.add(
            _getEstimatedColumnWidth(_PickerColumnType.date, widget.textColor));
      } else {
...
class _CupertinoDatePickerDateState extends State<IrisCupertinoDatePicker> {
  late int textDirectionFactor;
  late CupertinoLocalizations localizations;
  ...
  void _handleSystemFontsChange() {
    setState(() {
      // System fonts change might cause the text layout width to change.
      _refreshEstimatedColumnWidths(widget.textColor);
    });
  }
  ...
  void _refreshEstimatedColumnWidths(Color? textColor) {
    estimatedColumnWidths[_PickerColumnType.dayOfMonth.index] =
        IrisCupertinoDatePicker._getColumnWidth(
            _PickerColumnType.dayOfMonth, localizations, context, textColor);
    estimatedColumnWidths[_PickerColumnType.month.index] =
        IrisCupertinoDatePicker._getColumnWidth(
            _PickerColumnType.month, localizations, context, textColor);
    estimatedColumnWidths[_PickerColumnType.year.index] =
        IrisCupertinoDatePicker._getColumnWidth(
            _PickerColumnType.year, localizations, context, textColor);
  }
        ...
        children: List<Widget>.generate(12, (int index) {
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: _themeTextStyle(context,
                  isValid: !isInvalidMonth, textColor: widget.textColor),
            ),
          );
        }),
        looping: true,
        ...
        itemBuilder: (BuildContext context, int year) {
          ...
          return itemPositioningBuilder(
            ...
            Text(
              ...
              style: _themeTextStyle(context,
                  isValid: isValidYear, textColor: widget.textColor),
            ),
          );
        },
        selectionOverlay: selectionOverlay,
