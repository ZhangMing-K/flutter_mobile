...
class IrisScrollBehaviour extends ScrollBehavior {
  @override
  ScrollPhysics getScrollPhysics(BuildContext context) {
    switch (getPlatform(context)) {
      ...
      case TargetPlatform.windows:
        return const IrisScrollPhysics();
      default:
        return const IrisScrollPhysics();
    }
  }
...
class IrisScrollPhysics extends ScrollPhysics {
  /// Creates scroll physics that bounce back from the edge.
  const IrisScrollPhysics({ScrollPhysics? parent}) : super(parent: parent);

  @override
  IrisScrollPhysics applyTo(ScrollPhysics? ancestor) {
    return IrisScrollPhysics(parent: buildParent(ancestor));
  }
