...
class CollectionMessagesConnection {
  ...
  factory CollectionMessagesConnection.fromJson(Map<String, dynamic> json) {
    return CollectionMessagesConnection(
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is CollectionMessagesConnection &&
  ...
  @override
  String toString() => 'CollectionMessagesConnection(${toJson()})';
}
