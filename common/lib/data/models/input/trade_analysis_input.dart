...
class TradeAnalysisInput {
  ...
  factory TradeAnalysisInput.fromJson(Map<String, dynamic> json) {
    return TradeAnalysisInput(
  ...
  @override
  String toString() => 'TradeAnalysisInput(${toJson()})';
}
