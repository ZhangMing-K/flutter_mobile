...
abstract class ChartAxis {
  ...
  ChartAxis({
    ...
    double? visibleStarting,
    String? visibleStartingText,
    AutoScrollingMode? autoScrollingMode,
        ...
        visibleStartingText = visibleStartingText ?? '',
  ...
  //// Sets the starting point value of the graph when you want to show only 3 lines of vertical axes
  final double? visibleStarting;

  /// visible starting text
  final String? visibleStartingText;
...
abstract class ChartAxisRenderer with _CustomizeAxisElements {
  ...
  ChartAxisRenderer(this._axis) {
    ...
    _visibleStarting = _axis.visibleStarting;
    _visibleStartingText = _axis.visibleStartingText;
  }
  //ignore: prefer_final_fields
  late ChartAxis _axis;
  double? _visibleStarting;
  String? _visibleStartingText;
  ChartAxis? _oldAxis;
  ...
  void drawHorizontalAxesTickLines(
    ...
    final List<AxisLabel> axisVisibleLabels = axisRenderer._visibleLabels;
    final AxisLabel startingLabel = axisVisibleLabels[0];
    List<AxisLabel> visibleLabels = <AxisLabel>[];
    if (axisRenderer._visibleStarting != null) {
      visibleLabels.add(startingLabel);
      visibleLabels.add(AxisLabel(
        startingLabel.labelStyle,
        startingLabel.labelSize,
        axisRenderer._visibleStartingText!,
        axisRenderer._visibleStarting!,
        null,
        axisRenderer._visibleStartingText,
      ));
      if (axisVisibleLabels.length > 1) visibleLabels.add(axisVisibleLabels[1]);
    } else {
      visibleLabels = axisVisibleLabels;
    }
