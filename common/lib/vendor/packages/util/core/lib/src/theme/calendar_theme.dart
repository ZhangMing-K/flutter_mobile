...
class SfCalendarTheme extends InheritedTheme {
  ...
  const SfCalendarTheme({Key? key, this.data, required this.child})
...
class SfCalendarThemeData with Diagnosticable {
  ...
  SfCalendarThemeData copyWith({
    ...
    return SfCalendarThemeData.raw(
      ...
      viewHeaderBackgroundColor:
          viewHeaderBackgroundColor as Color? ?? this.viewHeaderBackgroundColor,
  ...
  bool operator ==(Object other) {
    ...
    final SfCalendarThemeData typedOther = other as SfCalendarThemeData;
