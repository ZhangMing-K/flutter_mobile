...
class DateTimeAxisRenderer extends ChartAxisRenderer {
  ...
  DateTime _increaseDateTimeInterval(
    ...
    if (isIntervalDecimal) {
      ...
      switch (axisRenderer._actualIntervalType!) {
        case DateTimeIntervalType.years:
          dateTime = DateTime(dateTime.year + interval as int, dateTime.month,
              dateTime.day, dateTime.hour, dateTime.minute, dateTime.second, 0);
          break;
        case DateTimeIntervalType.months:
          dateTime = DateTime(dateTime.year, dateTime.month + interval as int,
              dateTime.day, dateTime.hour, dateTime.minute, dateTime.second, 0);
          break;
        case DateTimeIntervalType.days:
          dateTime = DateTime(
        ...
        case DateTimeIntervalType.minutes:
          dateTime = DateTime(
              ...
              dateTime.day,
              dateTime.hour,
              dateTime.minute + interval as int,
              dateTime.second,
              0);
          break;
        case DateTimeIntervalType.seconds:
          dateTime = DateTime(
              ...
              dateTime.hour,
              dateTime.minute,
              dateTime.second + interval as int,
              0);
          break;
        case DateTimeIntervalType.auto:
          break;
      ...
      switch (axisRenderer._actualIntervalType!) {
        case DateTimeIntervalType.years:
          dateTime = DateTime(
              dateTime.year,
              dateTime.month + (interval * 12).floor() as int,
              dateTime.day,
              dateTime.hour,
              dateTime.minute,
              dateTime.second,
        ...
        case DateTimeIntervalType.months:
          dateTime = DateTime(
              dateTime.year,
              dateTime.month,
              dateTime.day + (interval * 30).floor() as int,
              dateTime.hour,
              dateTime.minute,
              dateTime.second,
              0);
        ...
        case DateTimeIntervalType.days:
          dateTime = DateTime(
              ...
              dateTime.month,
              dateTime.day,
              dateTime.hour + (interval * 24).floor() as int,
              dateTime.minute,
              dateTime.second,
              0);
          break;
        case DateTimeIntervalType.hours:
          dateTime = DateTime(
              ...
              dateTime.day,
              dateTime.hour,
              dateTime.minute + (interval * 60).floor() as int,
              dateTime.second,
              0);
          break;
        case DateTimeIntervalType.minutes:
          dateTime = DateTime(
              ...
              dateTime.hour,
              dateTime.minute,
              dateTime.second + (interval * 60).floor() as int,
              0);
          break;
        case DateTimeIntervalType.seconds:
          dateTime = DateTime(
  ...
  void applyRangePadding(_VisibleRange range, num? interval) {
    ...
    if (_dateTimeAxis.minimum == null && _dateTimeAxis.maximum == null) {
      ...
      final DateTime minimum = DateTime.fromMillisecondsSinceEpoch(_min as int);
      final DateTime maximum = DateTime.fromMillisecondsSinceEpoch(_max as int);
