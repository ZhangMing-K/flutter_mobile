...
class CandleSeriesRenderer extends XyDataSeriesRenderer {
  ...
  ChartSegment? _createSegments(CartesianChartPoint<dynamic>? currentPoint,
    ...
    _segment = createSegment() as CandleSegment?;
    ...
    if (_segment != null) {
      ...
      _segment!.points!
        ..add(Offset(currentPoint.markerPoint!.x as double,
            _segment!._highPoint!.y as double))
        ..add(Offset(currentPoint.markerPoint!.x as double,
            _segment!._lowPoint!.y as double))
        ..add(Offset(_segment!._openX as double, _segment!._topRectY as double))
        ..add(
            Offset(_segment!._closeX as double, _segment!._topRectY as double))
        ..add(Offset(
            _segment!._closeX as double, _segment!._bottomRectY as double))
        ..add(Offset(
            _segment!._openX as double, _segment!._bottomRectY as double));
