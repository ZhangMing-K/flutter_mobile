    ...
    if (seriesRenderer!._visible!) {
      ...
      for (int pointIndex = 0; pointIndex < pointsLength; pointIndex++) {
        ...
        if (point!.isVisible && !point.isDrop) {
          currentPointLow = _calculatePoint(
              point.xValue,
              point.low,
              xAxisRenderer,
              yAxisRenderer,
          ...
          renderPointhigh = _calculatePoint(point.xValue, point.high,
              xAxisRenderer, yAxisRenderer, isTransposed, series, axisClipRect);
          _points.add(
              Offset(currentPointLow.x as double, currentPointLow.y as double));
          _points.add(Offset(
              currentPointHigh.x as double, currentPointHigh.y as double));
          if (prevPoint == null ||
            ...
            _path.moveTo(
                currentPointLow.x as double, currentPointLow.y as double);
            _path.lineTo(
                currentPointHigh.x as double, currentPointHigh.y as double);
            _strokePath.moveTo(
                currentPointHigh.x as double, currentPointHigh.y as double);
              ...
              dataPoints[pointIndex + 1]!.isGap == true) {
            _path.cubicTo(
                point.highStartControl!.x as double,
                point.highStartControl!.y as double,
                point.highEndControl!.x as double,
                point.highEndControl!.y as double,
                renderPointhigh.x as double,
                renderPointhigh.y as double);
          ...
          if (dataPoints[pointIndex + 1]!.isGap == true) {
            ...
            if (pointIndex + 1 == dataPoints.length - 1 &&
              ...
              renderControlPointlow2 = _calculatePoint(
                  ...
                  axisClipRect);
              _strokePath.cubicTo(
                  renderControlPointlow2.x as double,
                  renderControlPointlow2.y as double,
                  renderControlPointlow1.x as double,
                  renderControlPointlow1.y as double,
                  renderPointlow.x as double,
                  renderPointlow.y as double);
            }
            controlPointslow = seriesRenderer!
                ._drawLowControlPoints[
                    seriesRenderer!._dataPoints!.indexOf(point)]
      ...
      if (seriesRenderer!._segments.isNotEmpty) {
