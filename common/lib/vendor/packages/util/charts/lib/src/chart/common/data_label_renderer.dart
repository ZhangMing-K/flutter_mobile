...
void _calculateDataLabelPosition(
  ...
  if (dataLabelSettingsRenderer._angle!.isNegative) {
    ...
    dataLabelSettingsRenderer._angle = angle as int?;
  }
  ...
  if (chart.onDataLabelRender != null &&
    ...
    index = dataLabelArgs.pointIndex as int?;
      ...
      if (seriesRenderer._seriesType == 'hiloopenclose' ||
        ...
        if (seriesRenderer._seriesType!.contains('hilo')) {
          ...
          if (seriesRenderer._chartState!._requireInvertedAxis!) {
            ...
            chartLocation4 = _ChartLocation(point.region!.bottomCenter.dx,
                markerPoint3.y! + boxPlotPadding);
          }
        } else {
          chartLocation4 = _ChartLocation(
              point.region!.bottomCenter.dx, markerPoint3.y! + 1);
        }
        if (isBoxSeries) {
...
void _calculateDataLabelRegion(
  ...
  if (dataLabelSettingsRenderer._color != null ||
    ...
    point.dataLabelRegion = Rect.fromLTWH(point.labelLocation.x as double,
        point.labelLocation.y as double, textSize.width, textSize.height);
    ...
    if (isRangeSeries || isBoxSeries) {
      ...
      point.dataLabelRegion2 = Rect.fromLTWH(point.labelLocation2.x as double,
          point.labelLocation2.y as double, textSize2.width, textSize2.height);
      if (margin == const EdgeInsets.all(0)) {
        ...
        point.dataLabelRegion2 = Rect.fromLTWH(
            point.labelLocation2.x as double,
            point.labelLocation2.y as double,
            textSize2.width,
            textSize2.height);
    ...
    if (seriesRenderer._seriesType!.contains('candle') ||
      ...
      point.dataLabelRegion3 = Rect.fromLTWH(point.labelLocation3.x as double,
          point.labelLocation3.y as double, textSize3.width, textSize3.height);
      if (margin == const EdgeInsets.all(0)) {
        ...
        point.dataLabelRegion3 = Rect.fromLTWH(
            point.labelLocation3.x as double,
            point.labelLocation3.y as double,
            textSize3.width,
            textSize3.height);
      ...
      point.dataLabelRegion4 = Rect.fromLTWH(point.labelLocation4.x as double,
          point.labelLocation4.y as double, textSize4.width, textSize4.height);
      if (margin == const EdgeInsets.all(0)) {
        ...
        point.dataLabelRegion4 = Rect.fromLTWH(
            point.labelLocation4.x as double,
            point.labelLocation4.y as double,
            textSize4.width,
            textSize4.height);
      ...
      if (isBoxSeries) {
        ...
        point.dataLabelRegion5 = Rect.fromLTWH(
            point.labelLocation5!.x as double,
            point.labelLocation5!.y as double,
            textSize5.width,
            textSize5.height);
        if (margin == const EdgeInsets.all(0)) {
...
double? _calculatePathActualPosition(
  ...
  final List<String?> dataLabelPosition = <String?>[]..length = (5);
  ...
  while (isOverLap && positionIndex < 4) {
    yLocation = _calculatePathPosition(
        ...
        _chartState,
        currentPoint,
        Size(series!.markerSettings.width / 2,
            series.markerSettings.height / 2));
...
/// getting label rect
Rect _calculateLabelRect(_ChartLocation? location, Size? textSize,
    EdgeInsets margin, bool needRect) {
  return needRect
      ? Rect.fromLTWH(
...
void _drawDataLabel(
  ...
  if (label != null &&
    ...
    final Rect labelRect = (point.labelFillRect != null)
        ...
        : Rect.fromLTWH(
            point.labelLocation.x as double,
            point.labelLocation.y as double,
            point.dataLabelRegion.width,
            point.dataLabelRegion.height);
    ...
    for (int pointIndex = 0; pointIndex < dataPoints.length; pointIndex++) {
      if (seriesRenderer._series!.dataLabelSettings.isVisible &&
        ...
        final Offset position = Offset(
            point.labelLocation.x as double, point.labelLocation.y as double);
            ...
            if (dataLabelSettingsRenderer._color != null ||
              ...
              if (dataLabel.margin == const EdgeInsets.all(0)) {
                ...
                point.outliersDataLabelRegion.add(Rect.fromLTWH(
                    point.outliersLocation[outlierIndex].x as double,
                    point.outliersLocation[outlierIndex].y as double,
...
RRect _rectToRrect(Rect rect, num radius) => RRect.fromRectAndCorners(rect,
    topLeft: Radius.elliptical(radius as double, radius),
...
Rect _validateRect(Rect rect, Rect clipRect) {
  ...
  rect = Rect.fromLTWH(left as double, top as double, rect.width, rect.height);
  return rect;
}
