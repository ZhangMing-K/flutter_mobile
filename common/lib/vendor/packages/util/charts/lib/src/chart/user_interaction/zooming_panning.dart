    ...
    for (int index = 0;
      ...
      if (axisRenderer._zoomFactor! <= 1.0 && axisRenderer._zoomFactor! > 0.0) {
        if (axisRenderer._zoomFactor! - 0.1 < 0) {
          ...
          axisRenderer._zoomFactor = axisRenderer._zoomFactor! - 0.1;
...
class ZoomPanBehaviorRenderer with ZoomBehavior {
        ...
        if (cumulative >= 1) {
          ...
          origin = origin > 1
              ...
              : origin < 0
                  ...
                  : origin;
          zoomFactor =
              (cumulative == 1) ? 1 : _minMax(1 / cumulative, 0, 1) as double?;
    ...
    for (int axisIndex = 0;
      ...
      if (axisRenderer._orientation == AxisOrientation.horizontal) {
        if (_zoomPanBehavior.zoomMode != ZoomMode.y) {
          axisRenderer._zoomPosition = axisRenderer._zoomPosition! +
  ...
  void _performPinchZooming(
    ...
    if (!(_zoomingRect.width > 0 && _zoomingRect.height > 0)) {
      ...
      pinchRect = Rect.fromLTWH(clipX as double, clipY as double,
          offsetRect.width / scaleX, offsetRect.height / scaleY);
  ...
  void _calculatePinchZoomFactor(SfCartesianChart chart, Rect pinchRect) {
    ...
    for (int axisIndex = 0;
      ...
      if ((axisRenderer._orientation == AxisOrientation.horizontal &&
        ...
        currentZoomPosition =
            currentPosition < 0 ? 0 : currentPosition as double;
        currentZoomFactor = currentFactor > 1 ? 1 : currentFactor as double;
    ...
    for (int axisIndex = 0;
      ...
      if ((axisRenderer._orientation == AxisOrientation.vertical &&
        ...
        if (cumulative >= 1) {
          ...
          axisRenderer._zoomPosition = zoomPosition as double?;
          axisRenderer._zoomFactor = zoomFactor as double?;
          axisRenderer._bounds = const Rect.fromLTWH(0, 0, 0, 0);
          axisRenderer._visibleLabels = <AxisLabel>[];
          if (_chart.onZoomEnd != null) {
            ZoomPanArgs? zoomEndArgs;
