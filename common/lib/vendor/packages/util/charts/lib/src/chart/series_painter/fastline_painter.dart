        ...
        if ((prevXValue! - xVal!).abs() >= xTolerance ||
          ...
          if (point.isVisible) {
            currentLocation = _calculatePoint(
                ...
                areaBounds);
            _points.add(Offset(
                currentLocation.x as double, currentLocation.y as double));
            if (prevPoint == null) {
              seriesRenderer!._segmentPath!.moveTo(
                  currentLocation.x as double, currentLocation.y as double);
            } else if (seriesRenderer!
                        ._dataPoints![pointIndex - 1]!.isVisible ==
                    false &&
              ...
              seriesRenderer!._segmentPath!.lineTo(
                  currentLocation.x as double, currentLocation.y as double);
            } else {
              seriesRenderer!._segmentPath!.moveTo(
                  currentLocation.x as double, currentLocation.y as double);
