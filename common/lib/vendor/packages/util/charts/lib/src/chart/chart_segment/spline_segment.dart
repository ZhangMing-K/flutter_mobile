...
class SplineSegment extends ChartSegment {
  ...
  void calculateSegmentPoints() {
    ...
    startControlX = _currentPoint!.startControl!.x as double?;
    startControlY = _currentPoint!.startControl!.y as double?;
    endControlX = _currentPoint!.endControl!.x as double?;
    endControlY = _currentPoint!.endControl!.y as double?;
  }
