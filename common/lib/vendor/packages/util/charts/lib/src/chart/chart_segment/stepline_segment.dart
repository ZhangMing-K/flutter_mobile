...
class StepLineSegment extends ChartSegment {
  ...
  void onPaint(Canvas canvas) {
    ...
    if (_series!.animationDuration > 0 &&
      ...
      _oldSegment = (_currentSegment!._oldSeriesRenderer!._segments.length -
                  1 >=
              currentSegmentIndex!)
      ...
      if (_series!.dashArray[0] != 0 && _series!.dashArray[1] != 0) {
        _path!.moveTo(_x1 as double, _y1 as double);
        _path!.lineTo(_x3 as double, _y3 as double);
        _path!.lineTo(_x2 as double, _y2 as double);
        _drawDashedLine(canvas, _series!.dashArray, strokePaint, _path);
      } else {
        canvas.drawLine(Offset(_x1 as double, _y1 as double),
            Offset(_x3 as double, _y3 as double), strokePaint!);
        canvas.drawLine(Offset(_x3 as double, _y3 as double),
            Offset(_x2 as double, _y2 as double), strokePaint!);
      }
    }
  }
}
