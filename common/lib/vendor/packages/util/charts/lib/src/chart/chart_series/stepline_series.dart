...
class StepLineSeriesRenderer extends XyDataSeriesRenderer {
  ...
  ChartSegment _createSegments(
      ...
      int? seriesIndex,
      num animateFactor) {
    final StepLineSegment segment = createSegment() as StepLineSegment;
    ...
    segment.points!.add(Offset(currentPoint._nextPoint!.x as double,
        currentPoint._nextPoint!.y as double));
