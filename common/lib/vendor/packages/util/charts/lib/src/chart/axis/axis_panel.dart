...
class _ChartAxis {
    ...
    if (axis.isVisible) {
      ...
      if (axisRenderer._orientation == AxisOrientation.horizontal) {
        if (!axis.opposedPosition) {
          axisRenderer._totalSize = axisRenderer._totalSize! +
          ...
          if (axisRenderer._crossValue != null &&
            ...
            axisRenderer._totalSize =
                crosPosition - axisRenderer._totalSize! < 0
          ...
          if (axisRenderer._crossValue != null &&
            ...
            final num crosPosition = _valueToCoefficient(
                ...
                rect!.height;
            axisRenderer._totalSize =
                crosPosition + axisRenderer._totalSize! > rect.height
                    ? ((crosPosition + axisRenderer._totalSize!) - rect.height)
                        .abs()
                    : !axis.placeLabelsNearAxisLine
                        ? labelSize
  ...
  num? _getPrevAxisOffset(List<_AxisSize>? axesSize, Rect? rect,
      int currentAxisIndex, String type) {
  ...
  void _calculateLeftAxesBounds() {
    ...
    for (int axisIndex = 0; axisIndex < axesLength; axisIndex++) {
      ...
      axisRenderer._bounds = Rect.fromLTWH(
          axisSize as double,
          rect!.top + axis.plotOffset,
          width as double,
  ...
  void _calculateBottomAxesBounds() {
    ...
    for (int axisIndex = 0; axisIndex < axesLength; axisIndex++) {
      ...
      axisRenderer._bounds = Rect.fromLTWH(
          rect!.left + axis.plotOffset,
          axisSize as double,
          rect.width - 2 * axis.plotOffset,
          height as double);
    }
  }
  ...
  void _calculateVisibleAxes() {
    ...
    _primaryYAxisRenderer!._name =
        _primaryYAxisRenderer!._name ?? 'primaryYAxis';
