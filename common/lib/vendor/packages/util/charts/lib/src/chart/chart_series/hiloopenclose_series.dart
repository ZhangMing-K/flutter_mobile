...
class HiloOpenCloseSeriesRenderer extends XyDataSeriesRenderer {
  ...
  ChartSegment? _createSegments(CartesianChartPoint<dynamic>? currentPoint,
    ...
    _segment = createSegment() as HiloOpenCloseSegment?;
    ...
    if (_segment != null) {
      ...
      _segment!.points!
        ...
        ..add(Offset(_segment!._openX as double, _segment!._openY as double))
        ..add(Offset(_segment!._closeX as double, _segment!._closeY as double));
  ...
  void customizeSegment(ChartSegment _segment) {
    ...
    _segment._strokeColor =
        _segment is HiloOpenCloseSegment && _segment._isBull!
